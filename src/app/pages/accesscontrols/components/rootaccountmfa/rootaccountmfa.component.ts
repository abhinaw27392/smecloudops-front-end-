...
@Component({
  selector: 'rootaccountmfa',
  templateUrl: './rootaccountmfa.html',
  styleUrls: ['./rootaccountmfa.scss']
})

export class ROOTACCOUNTMFA implements OnInit{
   public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_iam_mfa").subscribe(data => {
      this.ec2data(data);
