...
@Component({
  selector: 'rootaccountkey',
  templateUrl: './rootaccountkey.html',
  styleUrls: ['./rootaccountkey.scss']
})

export class ROOTACCOUNTKEY implements OnInit{
   public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_iam_acc_key").subscribe(data => {
      this.ec2data(data);
