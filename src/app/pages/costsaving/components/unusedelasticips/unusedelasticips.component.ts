...
@Component({
  selector: 'unusedelasticips',
  templateUrl: './unusedelasticips.html',
  styleUrls: ['./unusedelasticips.scss']
})

export class UNUSEDELASTICIPS implements OnInit{
  public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_unused_elasticip").subscribe(data => {
      this.ec2data(data);
  ...
  ec2data(res) {
    ...
    this.dtOptions = {
      ...
      pageLength: 25,
      columns: [{ title: 'PublicIp', data: 'PublicIp' },
