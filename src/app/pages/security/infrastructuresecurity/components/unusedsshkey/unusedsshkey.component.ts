...
@Component({
  selector: 'unusedsshkey',
  templateUrl: './unusedsshkey.html',
  styleUrls: ['./unusedsshkey.scss']
})

export class UNUSEDSSHKEY implements OnInit{
  public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_unused_keypair").subscribe(data => {
      this.ec2data(data);
  ...
  ec2data(res) {
    ...
    this.dtOptions = {
      ...
      pageLength: 25,
      columns: [{ title: 'KeyName', data: 'KeyName' },
