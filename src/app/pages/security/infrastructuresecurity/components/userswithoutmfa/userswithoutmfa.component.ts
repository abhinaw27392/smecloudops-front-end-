...
@Component({
  selector: 'userswithoutmfa',
  templateUrl: './userswithoutmfa.html',
  styleUrls: ['./userswithoutmfa.scss']
})

export class USERSWITHOUTMFA implements OnInit{
   public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_iamusers_without_mfa").subscribe(data => {
      this.ec2data(data);
