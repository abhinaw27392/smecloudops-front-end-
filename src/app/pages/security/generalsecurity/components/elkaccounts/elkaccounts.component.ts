...
@Component({
  selector: 'elkaccounts',
  templateUrl: './elkaccounts.html',
  styleUrls: ['./elkaccounts.scss']
})

export class ELKACCOUNTS implements OnInit{
  public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_elk").subscribe(data => {
      this.ec2data(data);
