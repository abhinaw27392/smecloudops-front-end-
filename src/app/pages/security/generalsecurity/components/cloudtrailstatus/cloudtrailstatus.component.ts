...
@Component({
  selector: 'cloudtrailstatus',
  templateUrl: './cloudtrailstatus.html',
  styleUrls: ['./cloudtrailstatus.scss']
})

export class CLOUDTRAILSTATUS implements OnInit {
   public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_cloudtrail_status").subscribe(data => {
      this.ec2data(data);
