...
@Component({
  selector: 'amicleanup',
  templateUrl: './amicleanup.html',
  styleUrls: ['./amicleanup.scss']
})

export class AMICLEANUP implements OnInit{
   public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_ami_cleanup").subscribe(data => {
      this.ec2data(data);
