...
@Component({
  selector: 'amiaudit',
  templateUrl: './amiaudit.html',
  styleUrls: ['./amiaudit.scss']
})

export class AMIAUDIT implements OnInit{
  public data = [];
  public update_time;
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_ami_audit").subscribe(data => {
      this.ec2data(data);
  ...
  ec2data(res) {
    ...
    this.dtOptions = {
      ...
      pageLength: 25,
      columns: [{ title: 'ImageId', data: 'ImageId' }, { title: 'Date', data: 'Date' },
