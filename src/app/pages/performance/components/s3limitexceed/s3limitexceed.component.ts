...
@Component({
  selector: 'app-s3limitexceed',
  templateUrl: './s3limitexceed.component.html',
  styleUrls: ['./s3limitexceed.component.scss']
})
export class S3limitexceedComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_s3_limit_exceed").subscribe(data => {
      this.ec2data(data);
