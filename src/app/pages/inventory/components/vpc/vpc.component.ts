...
export class VPC {
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_vpc").subscribe(data => {
      this.rdsdata(data);
  ...
  rdsdata(res) {
    ...
    this.dtOptions = {
      ...
      pageLength: 25,
     columns: [{title: 'CidrBlock',data: 'CidrBlock'},{title: 'State',data: 'State'},{title: 'VpcId',data: 'VpcId'},
      {title: 'Name',data: 'Name'},{title: 'BusinessUnit',data: 'BusinessUnit'},{title: 'ProjectCode',data: 'ProjectCode'},
