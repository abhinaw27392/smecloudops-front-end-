...
export class VPNCONNECTION {
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_vpn_conditions").subscribe(data => {
      this.rdsdata(data);
  ...
  rdsdata(res) {
    ...
    this.dtOptions = {
      ...
      pageLength: 25,
     columns: [{title: 'Name',data: 'Name'},{title: 'VpnId',data: 'VpnId'},{title: 'IpAddress',data: 'IpAddress'},
     {title: 'Status',data: 'Status'},{title: 'StatusLastChanged',data: 'StatusLastChanged'},{title: 'AccountName',data: 'AccountName'},
