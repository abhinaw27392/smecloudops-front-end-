...
@Component({
  selector: 'app-rdsbackup',
  templateUrl: './rdsbackup.component.html',
  styleUrls: ['./rdsbackup.component.scss']
})
export class RdsbackupComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get("http://localhost:3000/get_rds_backup").subscribe(data => {
      this.ec2data(data);
